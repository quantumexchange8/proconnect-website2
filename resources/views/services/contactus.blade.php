...
<!-- Section Banner -->
            ...
            <div class="hero-container">
                <div class="row row-cols-xl-2 row-cols-1 g-5">
                    <div class="col col-xl-5">
                        <div class="contact-title-wrapper animate-box animated animate__animated" data-animate="animate__fadeInLeft">
                            <div class="card contact-title">
                                ...
                                <p>Reach out to us for digital marketing or SEO expertise.</p>
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-center text-md-start text-center gspace-2">
                                    ...
                                    <div class="d-grid">
                                        ...
                                        <h6>contactus@proconnect.solutions</h6>
                                    </div>
                                </div>
                                {{-- <div class="d-flex flex-column flex-md-row align-items-center text-md-start text-center gspace-2">
                                    <div>
                                    ...
                                    <div class="d-grid">
                                        ...
                                        <h6>Marko HQ - 902 Digital Lane, San Francisco, CA 94110, USA</h6>
                                    </div> 
                                </div> --}}
                            </div>
                        </div>
                    ...
                    <div class="col col-xl-7">
                        ...
                        <div class="form-layout-wrapper animate-box animated animate__animated" data-animate="animate__fadeInDown">
        ...
        <div class="section pt-0">
            <div class="hero-container animate-box animated animate__animated" data-animate="animate__fadeInRight">
