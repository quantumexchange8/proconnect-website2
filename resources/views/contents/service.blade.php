                ...
                <div class="row row-cols-xl-3 row-cols-md-2 row-cols-1 grid-spacer-2">
                    <div class="col">
                        <div class="card card-service animate-box animated fast animate__animated" data-animate="animate__fadeInLeft">
                            ...
                            <p>
                                Create aesthetically pleasing, easily navigable websites that improve user experience and online presence while forging a distinctive online identity.
                            </p>
                            <div class="mt-auto">
                                <a href="/services/web-design" class="btn btn-accent">
                                    <div class="btn-title">
                        ...
                        <div class="card card-service animate-box animated animate__animated" data-animate="animate__fadeInLeft">
                            <div class="d-flex flex-row  gspace-2 gspace-md-3 align-items-center">
                                <div>
                                    <div class="service-icon-wrapper">
                                        <div class="service-icon">
                                            <i class="fa-solid fa-search feature-icon"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="service-title">
                    ...
                    <div class="col">
                        <div class="card card-service animate-box animated fast animate__animated" data-animate="animate__fadeInLeft">
                            ...
                            <p>
                                Using data analytics, you can make well-informed decisions for successful digital strategies by providing actionable insights into user behavior.
                            </p>
                            <div class="mt-auto">
                                <a href="/services/data" class="btn btn-accent">
                                    <div class="btn-title">
                                        <span>View Details</span>
                                    </div>
                                    <div class="icon-circle">
                        ...
                        <div class="card card-service animate-box animated slow animate__animated" data-animate="animate__fadeInLeft">
                            <div class="d-flex flex-row gspace-2 gspace-md-3 align-items-center">
                                <div>
                                    <div class="service-icon-wrapper">
                                        <div class="service-icon">
                                            <i class="fa-solid fa-file-alt feature-icon"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="service-title">
                            ...
                            <p>
                                To improve brand authority and establish a connection with the target audience, create compelling content that is suited for a variety of platforms.
                            </p>
                            <div class="mt-auto">
                                <a href="/services/content" class="btn btn-accent">
                                    <div class="btn-title">
                                        <span>View Details</span>
                                    </div>
                                    <div class="icon-circle">
                    ...
                    <div class="col">
                        <div class="card card-service animate-box animated animate__animated" data-animate="animate__fadeInLeft">
                            ...
                            <p>
                                Lead the way in developing a strong online foundation that is in line with business objectives through strategic planning and brand identity creation.
                            </p>
                            <a href="/services/formation" class="btn btn-accent">
                                <div class="btn-title">
                                    <span>View Details</span>
                                </div>
                                <div class="icon-circle">
                        ...
                        <div class="card card-service animate-box animated fast animate__animated" data-animate="animate__fadeInLeft">
                            <div class="d-flex flex-row gspace-2 gspace-md-3 align-items-center">
                                <div>
                                    <div class="service-icon-wrapper">
                                        <div class="service-icon">
                                        <i class="fa-solid fa-photo-video feature-icon"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="service-title">
                        ...
                        <div class="card card-service animate-box animated animate__animated" data-animate="animate__fadeInLeft">
                            <div class="d-flex flex-row gspace-2 gspace-md-3 align-items-center">
                                <div>
                                    <div class="service-icon-wrapper">
                                        <div class="service-icon">
                                            <i class="fa-solid fa-share-alt feature-icon"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="service-title">
                            ...
                            <p>
                                Use skillfully designed social media strategies that establish a personal connection with the audience to drive meaningful interactionis, brand loyalty, and conversions.
                            </p>
                            <div class="mt-auto">
                                <a href="/services/social" class="btn btn-accent">
                                    <div class="btn-title">
                                        <span>View Details</span>
                                    </div>
                                    <div class="icon-circle">
