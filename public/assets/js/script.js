...
//navbar active link
(function() {
    // Get current path, e.g., /services/web-design
    ...
    navbarLinks.forEach(function(link) {
        if (link.getAttribute('href') === currentPath) {
            link.classList.add('active'); // Bootstrap active class
        }
    });
    ...
    sidebarLinks.forEach(function(link) {
        if (link.getAttribute('href') === currentPath) {
            ...
            // If inside a dropdown, expand it
            var parentDropdown = link.closest('.sidebar-dropdown');
            if (parentDropdown) {
                parentDropdown.classList.add('open'); // custom class to expand
            }
        }
    });
})();
...
function initThemeSwitch() {
    ...
    const updateLogos = () => {
        ...
        if (lightMode) {
            ...
            //light mode
            siteLogos.attr('src', '/assets/image/Proconnect-logo-horizontal-dark.png');
            ...
            //dark mode
            siteLogos.attr('src', '/assets/image/Proconnect-logo-horizontal-light.png');
